...
Prima dell'attivazione usare Netlify staging + Supabase separato, dati fittizi e migration `065` applicata esplicitamente soltanto allo staging. Env e webhook sono descritti in `docs/KONA_AI_GUARDIAN_SETUP.md`.
