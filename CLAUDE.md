...
- `moduli/dashboard_pezzi.html`: layout più compatto. Le colonne operatori (`MATTEO`, `MIRKO`, `FRANCESCA`, `CEREA`) hanno larghezza fissa ridotta; le fasce colorate delle offerte sono applicate a una strip inline e finiscono quasi subito dopo il testo, senza espandersi a tutta pagina.
