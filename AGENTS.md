...
- Tutti i dati testuali disegnati sul PDF sono normalizzati server-side in stampato maiuscolo con locale italiano, indipendentemente dal formato digitato nel frontend. Le baseline sono sollevate rispetto alle righe prestampate: offset standard 2,2 pt e CF 1,6 pt. Il numero dell'utenza da disdire è evidenziato in Helvetica Bold 10 pt, spostato 5 pt a destra e sollevato di 3,3 pt, mantenendo invariato il distacco inferiore dalla riga rispetto alla precedente versione da 8,2 pt.
