...
Guardian e' pubblicato per la prova sul sito Netlify separato `mirox-crm-staging.netlify.app`, collegato al Supabase staging `blwgxrszvsoqcmcmhhqr`. Bootstrap e migration `065` risultano applicati soltanto li'; restano da creare l'utente Mirko e configurare OpenAI/Telegram. Non usare dati reali durante la validazione.
