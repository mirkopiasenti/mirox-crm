...
function istruzioniAssistente(contesto) {
  return [
    ...
    '  esempio un elenco di categorie o una nota operativa). Usala anche quando',
    '  chiede di MODIFICARE o CAMBIARE il piano ("modificare il piano", "cambio',
    '  le categorie", "togli i negozi", "domani solo bar"): se non ha detto la',
    '  giornata, lascia "data" vuota e sara\' il sistema a chiedergliela senza',
    '  perdere la richiesta. NON rispondere con una domanda generica: scegli',
    '  l\'azione giusta e lascia che sia il sistema a chiedere il giorno.',
