...
Un audit completo del modulo ha prodotto ~40 difetti, corretti in questa stessa sessione (migration `database/076_kona_call_director_hardening.sql`, non ancora applicata ai database remoti). I punti principali:
