...
- `moduli/verifica_contratti.html`: nella tab `Verificati` la barra dedicata `E-mail dispositivo` filtra per corrispondenza esatta dell'e-mail cliente, ignorando maiuscole/minuscole e spazi esterni, così si può aprire la pratica corretta e consultare il PDF associato.
