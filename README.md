...
- Integrità località 26/08/2026: dopo la bonifica dei duplicati sintattici, Supabase normalizza centralmente maiuscole, spazi, apostrofi ed entità HTML di `anagrafica.comune`/`provincia` per ogni sorgente, incluso il Call Center condiviso. Il catalogo `mirox_comuni_istat` contiene 7.893 denominazioni ufficiali aggiornate al 21/02/2026 ed è accessibile soltanto dal backend.
