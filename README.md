...
| `genera-pdf-consenso-cartaceo` | GET | authenticated | Stream del modulo cartaceo v5 precompilato: una pagina A4, monocromatico, corpo 10 pt, scelta marketing già marcata e riga firma |
