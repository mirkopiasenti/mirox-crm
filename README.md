...
| `gestisci-anagrafiche` | GET | authenticated | Elenco paginato e filtrato delle anagrafiche per il reparto Post-Vendita; `action=export` genera un file `.xlsx` completo con gli stessi filtri |
